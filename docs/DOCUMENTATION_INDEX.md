...
5. Use [AUTO_HEALING_SCENARIOS.md](AUTO_HEALING_SCENARIOS.md) when demonstrating failure coverage.
6. Use [OPERATIONS.md](OPERATIONS.md) while running or troubleshooting the project.
7. Use [DATA_MODEL.md](DATA_MODEL.md) when explaining persistence, warehouse, MTTD, and MTTR.
...
6. Use `OPERATIONS.md` to explain how manual review and rerun would work in production.
